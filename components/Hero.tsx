    ...
    <div className="hero min-h-screen bg-[#020309] relative overflow-hidden">
      ...
      <div className="absolute top-4 right-4 flex gap-4 z-30">
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="btn btn-outline border-[#0CC0DF] text-[#0CC0DF] hover:bg-[#0CC0DF] hover:text-white"
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2" viewBox="0 0 384 512">
      ...
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between relative z-20">
        ...
        <div className="lg:w-1/2 text-left px-4 lg:px-8">
          <motion.div
            initial={{ opacity: 0, x: -50 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8 }}
          >
            <h1 className="text-8xl sm:text-9xl font-black mb-8">
            ...
            <p className="text-3xl leading-relaxed max-w-2xl text-[#a0a0a0] font-bold drop-shadow-[0_0_15px_rgba(0,0,0,0.9)] mb-8">
              Every battle counts. Every drop matters. Portal your hard-earned items across games, secured forever on-chain.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="btn btn-lg bg-[#0CC0DF] hover:bg-[#0AA0BF] text-white font-bold text-xl px-12 rounded-full"
            >
              Try Now For Free
            </motion.button>
          </motion.div>
        ...
        <div className="lg:w-1/2 h-[80vh] relative z-10">
