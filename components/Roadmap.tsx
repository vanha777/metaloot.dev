...
export default function Roadmap() {
  ...
  return (
    <div className={`hero ${isMobile ? 'h-screen w-screen' : 'min-h-screen'} bg-[#020309] relative overflow-hidden`}>
          ...
          <div className="relative">
            ...
            >
              <motion.div
                ...
                className={`${phases[currentPhase].isActive ? 'bg-[#0CC0DF]/20' : 'bg-[#0CC0DF]/10'} backdrop-blur-sm rounded-xl overflow-hidden border border-[#0CC0DF]/30 mx-auto max-w-sm`}
              >
                <div className="p-6 flex flex-col items-center justify-center">
                  ...
                  <h3 className="text-xl font-bold mb-3 text-[#0CC0DF] text-center">
                    ...
                    {phases[currentPhase].isActive && <span className="ml-2 text-sm text-white bg-[#0CC0DF] px-2 py-1 rounded-full">Coming</span>}
                  </h3>
              ...
              <div className="absolute inset-y-0 left-0 right-0 flex justify-between items-center">
                <button onClick={prevPhase} className="p-2 bg-[#0CC0DF]/20 rounded-full backdrop-blur-sm">
                ...
                <button onClick={nextPhase} className="p-2 bg-[#0CC0DF]/20 rounded-full backdrop-blur-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#0CC0DF]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                {phases.map((_, index) => (
                  <div
                    ...
                    className={`h-2 rounded-full transition-all ${
                      currentPhase === index ? 'w-6 bg-[#0CC0DF]' : 'w-2 bg-[#0CC0DF]/30'
                    }`}
                  />
                ))}
              </div>
