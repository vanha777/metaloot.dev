...
export default function GamesDashboard() {
    ...
    const onGetRewards = async (game: Game) => {
        ...
        updateGameStats(
            game!.id,
            (game!.played || 0) + 1,
            (game!.rewarded || 0) + (game?.models?.playToEarn?.price || 0)
        );
    }
                                ...
                                {transferStatus === 'success' && (
                                    ...
                                    >
                                        ...
                                        <div className="max-w-md mx-auto space-y-4">
                                            ...
                                            <motion.button
                                                onClick={() => redirect()}
                                                className="w-full py-3 px-4 bg-[#0CC0DF] hover:bg-[#0AA0BF] text-white rounded-lg transition-colors duration-200 flex items-center justify-center gap-2"
                                                whileHover={{ scale: 1.02 }}
                                                whileTap={{ scale: 0.98 }}
                                                transition={{ duration: 0.2 }}
                                            >
